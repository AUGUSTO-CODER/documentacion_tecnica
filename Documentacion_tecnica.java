...
/**
 *
 * @author José Luis Huaynate Achachau
 * @author Mayta Huamán Augusto
 * @author ZUASNABAR OSCCO Stiven Axel
 */
import javax.swing.ImageIcon;
import javax.swing.JOptionPane;

public class Documenatcion_tecnica extends javax.swing.JFrame {
...
/**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Documenatcion_tecnica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Documenatcion_tecnica().setVisible(true);
            }
        });
    }
